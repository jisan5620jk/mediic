...
const ProjectCard = ({
  ...
  return (
    <div className='project-inner-box relative z-10 group rounded-md overflow-hidden'>
      ...
      <div className='project-inner-content mx-[30px] -mt-[90px] bg-gradient-to-b from-PrimaryColor-0 to-80% to-white rounded-2xl border-2 border-white overflow-hidden px-4 md:px-9 pt-6 pb-7 transition-all duration-500 relative z-10 group-hover:-mt-[120px]'>
        <div className='flex items-center justify-between'>
          <div>
            <h6 className='project-inner-sub-title font-AlbertSans text-[15px] font-medium text-white uppercase pt-2'>
              {projectSubTitle}
            </h6>
            <h5 className='project-inner-title font-AlbertSans font-bold text-HeadingColor-0 text-[22px] pt-[2px] uppercase'>
              {projectTitle}
            </h5>
          </div>
