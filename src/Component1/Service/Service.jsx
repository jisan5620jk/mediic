...
const Service = () => {
  ...
  return (
    <section className="service px-5 2xl:px-20 bg-Secondarycolor-0 bg-cover bg-bottom bg-no-repeat pt-[206px] pb-[150px] relative">
      <div className="grid grid-cols-12 items-center border-b border-BorderColor2-0 pb-7">
