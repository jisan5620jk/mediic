    ...
    <div className='group transition-all duration-500 rounded-lg bg-white shadow-shade'>
      ...
      <div className='rounded-b-lg relative z-20 flex justify-center transition-all duration-500 2xl:pr-14 pt-9'>
        <div>
          ...
          <Link to={blogUrl}>
            <button className='font-AlbertSans text-left font-semibold text-xl sm:text-[23px] md:text-xl lg:text-base xl:text-xl 2xl:text-[23px] text-HeadingColor-0 transition-all duration-500 hover:text-PrimaryColor-0 mt-2'>
              {blogTitle}
            </button>
          </Link>
        </div>
