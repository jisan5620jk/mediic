...
const Feature = () => {
  return (
    <section className="py-[120px] bg-BodyBg-0 bg-cover bg-no-repeat bg-left lg:bg-bottom relative z-10">
      <div className="Container relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          <div className="group px-10 pt-10 pb-11 bg-white bg-opacity-30 text-center rounded-3xl border-2 border-white relative z-10 overflow-hidden transition-all duration-500 hover:border-PrimaryColor-0">
