  ...
  return (
    <div className="text-center group relative">
      <div className="inline-block m-auto relative z-10 before:absolute before:-top-[13px] before:-left-[13px] before:w-[242px] before:h-[242px] before:border-[2px] before:border-dashed before:border-PrimaryColor-0 before:rounded-full before:animate-rotate">
        ...
        />
        <h6 className="w-[48px] h-[48px] rounded-full bg-PrimaryColor-0 text-white font-AlbertSans font-medium text-[22px] flex justify-center items-center absolute top-0 left-0">
          {boxNumber1}
        </h6>
      </div>
      <h5 className="font-AlbertSans font-semibold text-white text-2xl mt-9 mb-4">
        {processTitle}
      </h5>
