...
const PricingAccordion = ({ children, faqIcon, title, id, active = false }) => {
  ...
  return (
    <div className="mb-5 rounded-md overflow-hidden">
      <h2>
        <button
          className="faq-button2 rounded-md flex items-center justify-between pl-4 pr-2 md:pl-7 md:pr-6 lg:pl-6 lg:pr-4 xl:pl-7 xl:pr-6 py-5 w-full text-left font-medium font-AlbertSans transition-all duration-500 group bg-[#cedef7] border-b border-transparent"
          onClick={(e) => {
            e.preventDefault();
      ...
      <div
        ...
        className={`grid font-AlbertSans leading-[26px] text-TextColor2-0 bg-[#cedef7] px-4 md:px-7 lg:px-6 xl:px-7 overflow-hidden transition-all duration-300 ease-in-out bg-normalBlack ${
          accordionOpen
