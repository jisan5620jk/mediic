      ...
      <div className="Container">
        <div className="grid grid-cols-6 gap-10 lg:gap-0 lg:grid-cols-12">
          <div className="col-span-6 lg:col-span-5 w-full mx-auto pr-10">
            ...
            <h1 className="font-AlbertSans font-semibold text-HeadingColor-0 text-[16px] leading-[26px] sm:text-4xl sm:leading-[46px] md:text-[42px] md:leading-[52px] lg:text-[32px] lg:leading-[42px] xl:text-[38px] xl:leading-[48px] 2xl:text-[42px] 2xl:leading-[52px]">
            ...
            <p className="font-AlbertSans text-TextColor2-0 mt-6 mb-6 w-full">
            ...
            <ul className="flex flex-col sm:flex-row sm:items-center gap-10 2xl:gap-14 mb-9">
              <li className="flex items-center gap-2 text-HeadingColor-0 font-AlbertSans font-medium">
            ...
            <div className="pricing-box2 group text-center bg-BodyBg4-0 rounded-2xl overflow-hidden px-8 lg:px-4 xl:px-8 pt-9 pb-10 relative z-10 before:absolute before:top-0 before:right-0 before:-z-10 before:w-full before:h-0 before:bg-PrimaryColor-0 before:rounded-2xl before:transition-all before:duration-500 hover:before:h-full">
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <h6 className="pricing-title text-xl sm:text-2xl lg:text-xl xl:text-[22px] rounded font-AlbertSans text-HeadingColor-0 font-semibold transition-all duration-500 group-hover:text-white mt-4 mb-1">
                    Starter Plan
                  </h6>
                  <p className="pricing-desc font-AlbertSans text-TextColor2-0 transition-all duration-500 group-hover:text-TextColor-0 mb-4">
                    Indivisual
                  </p>
                </div>
              </div>
              <ul className="flex flex-col gap-3 mt-6 mb-9">
                <li className="pricing-list flex items-center gap-2 font-AlbertSans text-TextColor2-0 transition-all duration-500 group-hover:text-TextColor-0 border-b border-dashed border-[#1717173d] group-hover:border-BorderColor2-0 pb-3">
                  <img
                    src={icon}
                    draggable="false"
                    className="transition-all duration-500 group-hover:brightness-0 group-hover:invert-[1]"
              ...
              <div className="flex items-end gap-1 pb-5">
                <div className="flex gap-1">
                  <h6 className="pricing-price transition-all duration-500 group-hover:text-white font-AlbertSans font-semibold text-2xl text-PrimaryColor-0">
                    $
                  </h6>
                  <CountUp
                    start={-9}
                    ...
                    prefix=""
                    suffix=""
                    className="pricing-price text-[46px] leading-[45px] font-AlbertSans font-semibold text-PrimaryColor-0 transition-all duration-500 group-hover:text-white"
                  />
                </div>
                <h6 className="pricing-price-date font-AlbertSans text-TextColor2-0 text-lg transition-all duration-500 group-hover:text-TextColor-0">
                  / Month
                </h6>
              </div>
