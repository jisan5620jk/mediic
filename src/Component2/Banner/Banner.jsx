...
const Banner = () => {
  return (
    <div className='bg-BodyBg-0 px-2 lg:px-[30px]'>
      <section className='bg-[url(/images/hero-bg2.png)] bg-cover bg-no-repeat h-[650px] sm:h-[700px] md:h-[700px] lg:h-[700px] xl:h-[850px] 2xl:h-[850px] flex items-center relative z-10 overflow-hidden rounded-t-2xl md:rounded-[30px]'>
        ...
        <div className='absolute bottom-8 right-8 xl:bottom-[100px] xl:right-[100px] ml-8  flex flex-col sm:flex-row gap-5 bg-white bg-opacity-30 backdrop-filter backdrop-blur-md border-2 border-white rounded-[30px] pt-8 px-10 pb-9'>
