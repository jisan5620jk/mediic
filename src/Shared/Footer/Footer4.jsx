        ...
        <div className='grid grid-cols-12 gap-5 lg:gap-0 mt-24'>
          <div className='col-span-12 md:col-span-6 lg:col-span-2'>
            ...
            <ul>
              <li>
                <Link to={'/'}>
                  <button className='flex items-center gap-2 font-AlbertSans text-TextColor-0 transition-all duration-500 relative before:absolute before:bottom-0 before:right-0 before:w-0 before:h-[1px] before:bg-PrimaryColor-0 before:transition-all before:duration-500 hover:before:w-full hover:before:left-0 hover:text-PrimaryColor-0 mb-[18px]'>
                    Help Center
                  </button>
                </Link>
              </li>
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-3'>
            ...
            <p className='font-AlbertSans text-TextColor-0 my-7'>
          ...
          <div className='col-span-12 md:col-span-6 lg:col-span-4 xl:mr-10 2xl:mr-16'>
            ...
            >
              <input
                ...
                required
                className='w-full h-[58px] font-AlbertSans rounded-full bg-[#031b75] px-6 py-2 text-white placeholder:text-white placeholder:opacity-50 mb-4'
              />
              <button
                type='submit'
                className='absolute right-0 top-0 h-[58px] rounded-full border border-PrimaryColor-0 uppercase bg-PrimaryColor-0 gap-2 px-8 py-2 text-white font-AlbertSans flex items-center justify-cente'
              >
                Sign Up
              </button>
            </form>
        ...
        <div className='Container flex flex-col gap-5 md:flex-row md:gap-0 justify-between'>
          ...
          <div>
            <ul className='flex gap-7'>
              <li>
                <Link to={'/'}>
                  <button className='font-AlbertSans text-white transition-all duration-500 hover:opacity-100'>
                    Privacy & Terms.
                  </button>
                </Link>
              </li>
